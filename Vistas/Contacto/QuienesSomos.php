                ...
                <div class="col-12">
                    <nav class="float-left">
                        <div class="breadcrumb">
                            <div class="breadcrumb-item"><a href="../../index.php">Inicio</a></div>
                            <div class="breadcrumb-item active">¿Quienes Somos?</div>
                        </div>
                    </nav>
                </div>
            </div>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="pre-foo"><a href="Contacto.php">Contacto</a></td>
                            </tr>
                            <tr>
