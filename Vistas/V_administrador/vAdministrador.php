                        ...
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="#" class="dropdown-item">Validar Noticias</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="#" class="dropdown-item">Validar Festivales</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Area Administrador</a>
                                <div class="dropdown-menu">
                                    <a href="#" class="dropdown-item">Gestión Usuarios</a>
                                </div>
                            </li>
                            <li class="nav-item dropdown">
